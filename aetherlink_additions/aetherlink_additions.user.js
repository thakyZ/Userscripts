...
$(document).ready(function() {
  ...
  const transliterate = (word) => {
    ...
    a["Ё"]="E";a["Й"]="N";a["Ц"]="T";a["У"]="y";a["К"]="K";a["Е"]="E";a["Н"]="H";a["Г"]="T";a["Ш"]="W";a["Щ"]="W";a["З"]="3";a["Х"]="X";a["Ъ"]="b";
    a["ё"]="e";a["й"]="n";a["ц"]="u";a["у"]="y";a["к"]="k";a["е"]="e";a["н"]="H";a["г"]="r";a["ш"]="w";a["щ"]="w";a["з"]="3";a["х"]="x";a["ъ"]="b";
    a["Ф"]="o";a["Ы"]="bl";a["В"]="b";a["А"]="А";a["П"]="N";a["Р"]="P";a["О"]="O";a["Л"]="N";a["Д"]="A";a["Ж"]="X";a["Э"]="3";
    a["ф"]="o";a["ы"]="bl";a["в"]="B";a["а"]="a";a["п"]="n";a["р"]="p";a["о"]="o";a["л"]="n";a["д"]="A";a["ж"]="x";a["э"]="3";
    a["Я"]="R";a["Ч"]="4";a["С"]="C";a["М"]="M";a["И"]="N";a["Т"]="T";a["Ь"]="b";a["Б"]="b";a["Ю"]="lo";
    a["я"]="R";a["ч"]="4";a["с"]="c";a["м"]="m";a["и"]="n";a["т"]="T";a["ь"]="b";a["б"]="b";a["ю"]="lo";
    a["Є"]="E";a["є"]="E";a["Ι"]="I";a["ι"]="I";
  ...
  const CheckEveryLetter = (name) => {
    ...
    for (var i = 0; i < name.length; i++) {
      var code = name.codePointAt(i);
      if (code - 119808 >= 0 && code - 119808 < 1025) {
        newName = newName + String.fromCodePoint(((code - 119808) % 52) + 65);
      } else if (code >= 56745 || (code >= 9728 && code <= (9728 + 1024))) {
        newName = newName
      } else {
        newName = newName + transliterate(String.fromCodePoint(code));
      }
    }
    return newName;
  }
  ...
  const GetModAuthor = () => {
    return CheckEveryLetter($(".author").text()
      .replace(/\s/gi,"_")
      .replace(/[\[\(\]\)\{\}\.]/gi,""))
      .replace(/\s?[\u0000-\u001F\u007B-\uFFFF]\s?/gi,"");
  }
