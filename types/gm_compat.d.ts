...
export interface GMCompatApply {
  <T, A extends IArguments, R>($this: T, fn: ((this: T, ...args: any[]) => R), args: A): R;
  <T, A extends readonly any[], R>($this: T, fn: ((this: T, ...args: A) => R), args: A): R;
}
