...
export {
  FieldValue, FieldTypes, InitOptionsNoCustom, InitOptions,
  Field, CustomType, GM_configInit, GM_configDefaultValue,
  GM_configStruct, GM_configStruct as GMConfig, GM_config,
  GM_configField
};
