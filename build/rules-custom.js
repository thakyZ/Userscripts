import { MonkeyCodeType, getMonkeyCodeNames } from "./eslint.lib.js";

// cSpell:ignore wrap-iife, smalloc
...
export default {
  rules: {
    ...
    // Disabled for now as Firefox doesn't support named capture groups and
    // I"m tired of getting issues about the use of named capture groups...
    ...
    "new-cap": [
      "error",
      {
        newIsCap: true,
        capIsNew: true,
        capIsNewExceptions: getMonkeyCodeNames(MonkeyCodeType.string),
        newIsCapExceptions: getMonkeyCodeNames(MonkeyCodeType.string),
      },
    ],
    "new-parens": "error",
  ...
  // Output["new-cap"][1].capIsNewExceptions = getMonkeyCodeNames(MonkeyCodeType.string);
  // output["new-cap"][1].newIsCapExceptions = getMonkeyCodeNames(MonkeyCodeType.string);
  // return { rules: output };
};
